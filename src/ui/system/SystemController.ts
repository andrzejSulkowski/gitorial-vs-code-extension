import { WebviewToExtensionSystemMessage, ExtensionToWebviewSystemMessage } from "@gitorial/shared-types";
...
export class SystemController implements IWebviewSystemMessageHandler {
    ...
    public getSystemHealth(): SystemHealth {
        return {
            ...
            extensionUptime: Date.now() - this.extensionContext.globalState.get('startupTime', Date.now())
        };
    }
